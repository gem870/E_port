  ...
  return (
    ...
    >
      ...
      <motion.section
        ...
        className="border-2 border-gray-200 flex flex-col justify-center items-center text-center p-16 md:p-20 my-4 bg-gray-100 rounded-lg shadow-xl md:max-w-4xl"
      >
